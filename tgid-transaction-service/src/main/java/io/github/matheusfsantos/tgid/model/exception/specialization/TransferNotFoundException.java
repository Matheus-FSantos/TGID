...
public class TransferNotFoundException extends TgidException {
	...
	public TransferNotFoundException (String message, String description) {
		super(message, description, HttpStatus.NOT_FOUND, LocalDateTime.now());
	}
	
	public TransferNotFoundException (List<String> messages, String description) {
